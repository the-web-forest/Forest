...
## Philosophy 🌳
Web Forest is an NGO, our goal is straightforward: We want to improve the world using technology and ecology.
To achieve our objective we develop a gamified platform that allows the users to plan trees in real-world 100% online using their credit card. Got confused? I will explain! 
...
## Description 🌲
**Forest** is a collection of .NET microservices that allows Web Forest to operate. Currently, we have those microservices described below and you can see their code on this Github repository. 

Our microservices are baptized with plant/trees names in Brazillian Portuguese, so we have: 
